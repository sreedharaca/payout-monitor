...
namespace Katana\AffiliateBundle\Controller;
...
class AffiliateController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('KatanaAffiliateBundle:Affiliate')->findAll();
     ...
     *
     * @Route("/", name="affiliate_create")
     * @Method("POST")
     * @Template("KatanaAffiliateBundle:Affiliate:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('affiliate_show', array('id' => $entity->getId())));
        }
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('KatanaAffiliateBundle:Affiliate')->find($id);
    ...
    */
     ...
     *
     * @Route("/{id}", name="affiliate_update")
     * @Method("PUT")
     * @Template("KatanaAffiliateBundle:Affiliate:edit.html.twig")
     */
